...
public class CreateEditDeleteUserController implements Initializable {
    ...
    private void backButtonOnAction(ActionEvent event) {
        SceneNavigator.goToScene(event, backButton, "/com/azerstar/view/settings.fxml");
    }

    public void createUserButtonOnAction(ActionEvent event) {
        try {
            Parent createUserScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/createUser.fxml"));
    ...
    public void editUserButtonOnAction(ActionEvent event) {
        ...
        if (selectedUser != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/azerstar/view/updateUser.fxml"));
