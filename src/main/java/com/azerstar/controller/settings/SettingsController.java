...
public class SettingsController {
    ...
    public void userPermissionsButtonOnAction (ActionEvent event) {
        try {
            // Goods Receipt getmek ucun FXML faylı
            Parent userPermissionsScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/settings/userPermissions.fxml"));
    ...
    public void databaseConnectionSettingsButtonOnAction (ActionEvent event) {
        try {
            // Goods Receipt getmek ucun FXML faylı
            Parent databaseConnectionSettingsScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/settings/databaseConnectionSettings.fxml"));
