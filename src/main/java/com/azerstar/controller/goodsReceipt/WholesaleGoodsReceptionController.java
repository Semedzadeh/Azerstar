...
public class WholesaleGoodsReceptionController implements Initializable {
    ...
    private void backButtonOnAction(ActionEvent event) {
        SceneNavigator.goToScene(event, backButton, "/com/azerstar/view/goodsReceipt/goodsReceipt.fxml");
    }
    ...
    public void createWholesaleGoodsReceptionButtonOnAction(ActionEvent event){
        try {
            Parent createWholesaleGoodsReceptionScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/goodsReceipt/createWholesaleGoodsReception.fxml"));
    ...
    public void updateWholesaleGoodsReceptionButtonOnAction(ActionEvent event){
        ...
        if (selectWholesaleGoodsReception != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/azerstar/view/goodsReceipt/updateWholesaleGoodsReception.fxml"));
