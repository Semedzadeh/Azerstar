...
public class DryingController {
    ...
    public void tankDryingButtonOnAction (ActionEvent event) {
        try {
            ...
            Parent tankDryingScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/tankDrying.fxml"));
    ...
    public void sunDryingButtonOnAction (ActionEvent event) {
        try {
            // Goods Receipt getmek ucun FXML faylı
            Parent sunDryingButtonScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/sunDrying.fxml"));
