...
public class RetailGoodsReceptionController  implements Initializable {
    ...
    public void createRetailGoodsReceptionButtonOnAction(ActionEvent event) {
        try {
            Parent createRetailGoodsReceptionScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/goodsReceipt/createRetailGoodsReception.fxml"));
    ...
    public void updateRetailGoodsReceptionButtonOnAction(ActionEvent event) {
        ...
        if (selectRetailGoodsReception != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/azerstar/view/goodsReceipt/updateRetailGoodsReception.fxml"));
