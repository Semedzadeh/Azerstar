...
public class ReportController {
    ...
    public void goodsReceptionReportButtonOnAction (ActionEvent event) {
        try {
            ...
            Parent goodsReceptionReportScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/goodsReceptionReport.fxml"));
    ...
    public void finishedKernelReportButtonOnAction (ActionEvent event) {
        try {
            // Goods Receipt getmek ucun FXML faylı
            Parent finishedKernelReportScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/finishedKernelReport.fxml"));
    ...
    public void transferredKernelReportButtonOnAction (ActionEvent event) {
        try {
            // Goods Receipt getmek ucun FXML faylı
            Parent transferredKernelReportScene = FXMLLoader.load(getClass().getResource("/com/azerstar/view/transferredKernelReport.fxml"));
